...
function MakeMonth (month, year) {
  ...
  let currentMonthResults = currentMonth(month, year);

  let monthName = currentMonthResults[0];
  let returnedMonth = currentMonthResults[1];
  let returnedYear = currentMonthResults[2];
