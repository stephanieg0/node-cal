...
//64 spaces across
    ...
    finalSpaces.splice(4, 0, '\n');
    finalSpaces.splice(5,0, weekDays);
    finalSpaces.splice(9, 0, '\n');
    finalSpaces.splice(10,0, weekDays);
    finalSpaces.splice(14, 0, '\n');
    finalSpaces.splice(15,0, weekDays);
